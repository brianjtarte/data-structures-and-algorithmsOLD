...
const addExclamation = (arr) => {
  ...
  arr.forEach(exc => newExclamation.push(exc +'!'));
...
const allUpperCase = (arr) => {
  ...
  arr.forEach(str => upperCase.push(str.toUpperCase()));
...
const speaker = (words, callback) => {
  ...
  words.forEach(str => speakArr.push(callback(str)));
