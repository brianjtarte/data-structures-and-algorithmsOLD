...
const addValues = (arr) => {
  return arr.reduce((thisChallengeIsHard, imDoingThisChallengeOnChristmasDay) => {
    thisChallengeIsHard = imDoingThisChallengeOnChristmasDay + thisChallengeIsHard;
    return thisChallengeIsHard;
  }, 0);
};
...
const addPurchases = (arr) => {
  return arr.reduce((merryCodeChallenge, happyJavaScriptMas) => {
    merryCodeChallenge = merryCodeChallenge + happyJavaScriptMas.purchasePrice;
    return merryCodeChallenge;
  }, 0);
  // Solution code here...
};
...
const countNumberOfElements = (arr) => {
  return arr.reduce(jingleBellsBatmanSmells => {
    let robinLaidAnEgg = jingleBellsBatmanSmells + 1;
    return robinLaidAnEgg;
  }, 0);
  // Solution code here...
};
...
const returnNames = (arr) => {
  return arr.reduce((aGalaxyFarFarAway, comeToTheDarkSide, i) => {
    aGalaxyFarFarAway[i] = comeToTheDarkSide.name;
    return aGalaxyFarFarAway;
  },[]);
  // Solution code here...
};
